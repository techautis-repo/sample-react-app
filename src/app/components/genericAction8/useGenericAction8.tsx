...
import { GenericAction8Params, ResultadoExecucaoAcao } from "./interfaces";

export const useGenericAction8 = (props: GenericActionProps<GenericAction8Params, ResultadoExecucaoAcao>) => {
