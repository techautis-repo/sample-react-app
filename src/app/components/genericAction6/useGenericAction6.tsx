...
import { GenericAction6Params, ResultadoExecucaoAcao } from "./interfaces";

export const useGenericAction6 = (props: GenericActionProps<GenericAction6Params, ResultadoExecucaoAcao>) => {
