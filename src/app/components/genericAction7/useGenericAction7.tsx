...
import { GenericAction7Params, ResultadoExecucaoAcao } from "./interfaces";

export const useGenericAction7 = (props: GenericActionProps<GenericAction7Params, ResultadoExecucaoAcao>) => {
